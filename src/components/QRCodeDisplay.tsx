...
export const QRCodeDisplay: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <div
        className="bg-white p-2 rounded-xl shadow-sm border border-gray-100 mb-6 relative overflow-hidden animate-in zoom-in-95 fade-in duration-500"
      >
        <img
        ...
        <div
          className="absolute left-0 right-0 h-0.5 bg-blue-400/50 shadow-[0_0_8px_2px_rgba(59,130,246,0.5)] z-10 animate-scan"
        />
      </div>
